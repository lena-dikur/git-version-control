...
Чтобы в полной мере использовать возможности git нужен текстовый формат документов и MS Word для этих целей не подходит. Мы будем использовать Markdown - это простой язык текстовой разметки. Он предназначен для создани красиво оформленных текстов в обычных файлах формата TXT.
